            ...
            <div class="main-content">
                ...
                <div class="inventory-section">
                    ...
                    <p class="subtitle">
                        ...
                        <!-- Role-Aware Status Text -->
                        (Status: <?php echo $totalActive; ?>/<?php echo ($user_role === 'Teacher') ? 'Unlimited' : $limitMax; ?> slots used)
                    </p>

                    <form method="GET" action="student_teacher_borrow.php" class="search-filters" style="max-width: 100%;">
